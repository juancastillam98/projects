...
export const Modal = ({setModal, animarModal, setAnimarModal, guardarGasto, gastoEditar, gastosActualizados}) => {
	...
	const handleSubmit =(e)=>{
		...
		guardarGasto({nombre, cantidad, categoria, id, fecha})//crea un nuevo objeto
	}
	return (
		<div className="modal">
